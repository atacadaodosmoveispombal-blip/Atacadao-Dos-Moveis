(() => {
  ...
  async function renderOnlineSales(revision) {
    ...
    $('#onlineSalesForm .settings-toggles').insertAdjacentHTML('beforeend', `<label class="toggle"><input name="guest_checkout_enabled" type="checkbox" ${settings.guest_checkout_enabled !== false ? 'checked' : ''}> Permitir compra sem cadastro</label>`);
